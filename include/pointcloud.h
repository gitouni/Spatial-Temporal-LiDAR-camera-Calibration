...
void TransformationPointCloud(const VecVector3d &srcPointCloud, VecVector3d &tgtPointCloud, const Eigen::Isometry3d &transformation){
...
void TransformationPointCloud(const VecVector3d &srcPointCloud, VecVector3d &tgtPointCloud, const Eigen::Matrix4d &transformation){
    tgtPointCloud.resize(srcPointCloud.size());
    for(std::size_t i = 0; i<srcPointCloud.size(); ++i)
