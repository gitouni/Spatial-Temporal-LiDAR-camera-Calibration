...
public:
    ...
    //add by chy
    int OptimizeExtrinsicLocal(const vector<Eigen::Isometry3d> &vTwl, Eigen::Isometry3d &Tcl, double &scale, bool verbose=true);
    int OptimizeExtrinsicGlobal(const vector<Eigen::Isometry3d> &vTwl, Eigen::Isometry3d &Tcl, double &scale, bool verbose=true);
